...
void forward_mlp_standard(cutlass::half_t* output,
                              const cutlass::half_t* input,
                              const cutlass::half_t* gate_weight,
                              const cutlass::half_t* up_weight,
                              const cutlass::half_t* down_weight,
    ...
    cutlass_gemm_standard<true,false>(
        gate_silu_output,
        input,
        gate_weight,
        nullptr,
    ...
    cutlass_gemm_standard<false,false>(
        reinterpret_cast<cutlass::half_t*>(up_output),
        reinterpret_cast<const cutlass::half_t*>(input),
        reinterpret_cast<const cutlass::half_t*>(up_weight),
        nullptr,
...
void forward_mlp_single_token(cutlass::half_t* output,
                              const cutlass::half_t* input,
                              const cutlass::half_t* gate_weight,
                              const cutlass::half_t* up_weight,
                              const cutlass::half_t* down_weight,
...
void forward_mlp_single_token_blackwell(cutlass::half_t* output,
                                        const cutlass::half_t* input,
                                        const cutlass::half_t* gate_weight,
                                        const cutlass::half_t* up_weight,
                                        const cutlass::half_t* down_weight,
    ...
    cutlass_gemv_blackwell<true,false>(
        gate_silu_output,
        input,
        gate_weight,
        nullptr,
    ...
    cutlass_gemv_blackwell<false,false>(
        reinterpret_cast<cutlass::half_t*>(up_output),
        reinterpret_cast<const cutlass::half_t*>(input),
        reinterpret_cast<const cutlass::half_t*>(up_weight),
        nullptr,
...
void forward_moe_single_token_cutlas(const MoeInputsParams& params) {
    MOE_PRINT("[HOST INFO] Single token path with cuBLAS\n");
...
void forward_moe(const MoeInputsParams& params) {
    ...
    if (num_tokens == 1) {
        ...
        // forward_moe_single_token_cutlas(params);
        return;
    }
    ...
    for (int e = 0; e < num_experts; ++e) {
      ...
      forward_mlp_blackwell(mlp_output,
                            ...
                            params.stream);
#else
      forward_mlp_standard(mlp_output,
                mlp_input,
                mlp_gate_weight,
                mlp_up_weight,
                mlp_down_weight,
