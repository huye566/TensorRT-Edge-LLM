...
# model info
# MODEL_PATH=/root/.cache/huggingface/hub/Qwen3-VL-2B-Instruct
# MODEL_PATH=/root/.cache/huggingface/hub/Qwen3-VL-30B-A3B-Instruct
MODEL_PATH=/root/.cache/huggingface/hub/Qwen3-VL-4B-MoE-Init/exported_model
ONNX_DIR=${MODEL_PATH}/vlm_onnx_edgellm
ENGINE_DIR=${ONNX_DIR}/engines
DATA_SETS="/workspace/app/datasets/cnn_dailymail"
DATA_SETS_VIT="/workspace/app/datasets/lmms-lab/MMMU"

# 3rds
OPT_DIR=/workspace/app/ml/opt
CUDA_ARCH_X86=86
CUDA_VERSION=12.8
TENSORRT_VERSION=10.12.0.36
export LD_LIBRARY_PATH=${OPT_DIR}/TensorRT-${TENSORRT_VERSION}/lib:${OPT_DIR}/cuda-12.8/lib64:$LD_LIBRARY_PATH
